...
const cors = require("cors"); // Middleware para permitir conexionesdesde el frontend
const bodyParser = require("body-parser"); // Middleware para parsear JSON en laspeticiones
...
app.use(bodyParser.json()); // Permite recibir datos en formato JSON en el cuerpode las peticiones POST/PUT
